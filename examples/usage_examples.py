    ...
    product_expert = Persona(
        ...
        traits=[
            ...
            Trait(
                ...
                description="Knowledge of competitive landscape",
                weight=1.2,
            ),
            Trait(
                name="Prioritization", description="Ability to focus on what matters", weight=1.3
            ),
        ],
        focus_areas=[
            "User Research",
...
async def example_async():
    ...
    # Async consult
    result = await council.consult_async("What are the key risks in our expansion plan?")
