...
from .doctor import cost_group
from .doctor import doctor as doctor_command
from .doctor import show_providers as show_providers_command
from .doctor import test_key as test_key_command
...
from .qa import qa_command as qa_command
