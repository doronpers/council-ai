...
def main():
    parser = argparse.ArgumentParser(description="Launch the LLM Response Reviewer web application")
    parser.add_argument(
        "--port", "-p", type=int, default=8765, help="Port to run the server on (default: 8765)"
    )
    parser.add_argument(
